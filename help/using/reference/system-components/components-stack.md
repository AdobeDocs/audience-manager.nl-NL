...
title: Belangrijkste componenten in het Audience Manager-systeem
...
# Belangrijkste componenten in het Audience Manager-systeem{#key-components-in-the-audience-manager-system}

Audience Manager groepeert zijn systemen en processen in vier hoofdcategorieën: beheer van tags, gegevensverzameling, gegevensorganisatie en activering van gegevens.
...
In de volgende afbeelding ziet u de belangrijkste componenten en de onderliggende technologie (hardware en software) die [!DNL Audience Manager] van stroom voorziet. Hoewel sommige processen specifieke functies uitvoeren en anderen multifunctionele rollen hebben, werken alle systemen samen om u te helpen markeringen beheren, gegevens verzamelen, prestaties analyseren, informatie synchroniseren met andere systemen, en actie ondernemen op die informatie.
