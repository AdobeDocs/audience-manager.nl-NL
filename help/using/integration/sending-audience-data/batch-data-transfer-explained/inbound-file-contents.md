...
# Inbound Data File Contents: Syntax, Invalid Characters, Variables en Examples {#inbound-data-file-contents-syntax-invalid-characters-variables-and-examples}
...
Voor andere toegelaten formaten van de dossierinhoud, zie {de Integraties van de Partner van 0} Douane [.](/help/using/integration/sending-audience-data/custom-partner-integrations.md)
...
De tabel bevat een lijst met en definieert de variabelen die worden gebruikt in een bestand met correct opgemaakte binnenkomende gegevens. *Cursief* wijst op veranderlijke placeholder.
...
<table id="table_FE043CE392B34D5194111188E5C39671"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Een gebruikersnaam kan: </p> <p> 
     <ul id="ul_25168355353545A9A049D0083403025E"> 
      <li id="li_23829FE2F6464E33859B3E388FCD106B">Een unieke gebruikersnaam die is toegewezen door <span class="keyword"> Audience Manager </span> ( <a href="../../../reference/ids-in-aam.md"> Audience Manager UUID </a> ). </li> 
      ...
      <li id="li_52ABF6CCBCD147E2BD84D056F7461BA0">Een mobiele Android- of iOS-apparaat-id in de oorspronkelijke, ongewijzigde vorm zoals deze door het mobiele besturingssysteem wordt weergegeven. </li> 
     </ul> </p> <p>Voor mobiele id's: </p> <p> 
     <ul id="ul_717A17E11565427E9E2D9D7554BB231B"> 
      <li id="li_83BC5EA1E0294651A1F11D7E78EBCE98">IDFA-indeling: id's moeten hoofdletters en kleine letters zijn en geen hashed. Bijvoorbeeld: <code> 6D92078A-8246-4BA4-AE5B-76104861E7DC </code> </li> 
      <li id="li_27F298E62A1E46F88ECF52A01B752D3A">Android-indeling: id's moeten kleine letters zijn en geen hashing. Bijvoorbeeld: <code> 97987bca-ae59-4c7d-94ba-ee4f19ab8c21 </code> </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>De <span class="keyword"> standaard-id voor Audience Manager </span> . Wij vragen dat u <i> slechts ongebogen eigenschappen </i> in binnenkomende gegevensdossiers omvat. We verwerken geen andere typen eigenschappen in de binnenkomende gegevensoverdracht. </p> <p> <p>Opmerking: de Trait-id kunt u vinden met de GET-methode die details retourneert over al je kenmerken. Zie <a href="../../../api/rest-api-main/api-traits.md"> Trait API-methoden </a> voor meer informatie. </p> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_AD54B3E5487E47C481A4E5FD3A93FDA5"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Het voorvoegsel <code> d_sid </code> vertelt ons systeem dat de id een <span class="keyword"> Audience Manager </span> -kenmerk-id is. Dit is dezelfde id die in de gebruikersinterface wordt weergegeven. U kunt ook doel-id's retourneren met de API <code> GET </code> -methode. Zie <a href="../../../api/rest-api-main/api-traits.md"> Trait API-methoden </a> . </p> </td>
  </tr>
  <tr> 
   <td colname="col1"> <p> <code> d_unsid= </code> </p> </td> 
   <td colname="col2"> <p>Gegevens die met <code> d_unsid </code> zijn voorafgegaan, verwijderen gebruikers van die eigenschap. Het voorvoegsel <code> d_unsid </code> wordt genegeerd in een <code> overwrite </code> -bestand. </p> <p>Het voorvoegsel <code> d_unsid= </code> vertelt ons systeem dat de id een <span class="keyword"> Audience Manager </span> -kenmerk-id is. Dit is dezelfde id die in de gebruikersinterface wordt weergegeven. U kunt ook doel-id's retourneren met de API <code> GET </code> -methode. Zie <a href="../../../api/rest-api-main/api-traits.md"> Trait API-methoden </a> . </p> </td>
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code> ic= </code> </p> </td> 
   <td colname="col2"> <p> <a href="../../../features/traits/manage-trait-rules.md#managing-trait-rules"> Met de overtrekregels </a> kunt u criteria instellen voor de kwalificatie van de eigenschap. Als u een regel met een kenmerk opmaakt als <code> ic == trait ID </code> , kunt u kenmerken in een eenvoudige lijst met komma's opmaken. </p> <p>Stel bijvoorbeeld dat u deze drie regels voor de eigenschap maakt: </p> <p> 
     <ul class="simplelist"> 
      <li> <code> ic == "123" </code> </li>
      <li> <code> ic == "456" </code> </li>
      <li> <code> ic == "789" </code> </li>
     </ul> </p> <p>Deze kenmerken zijn gekoppeld aan de <code> ic </code> -toets. Zo kunt u een eenvoudigere lijst met eigenschappen maken in het gegevensbestand. U hoeft het voorvoegsel <code> ic </code> niet op te nemen. Hierdoor kan de inhoud van het gegevensbestand er als volgt uitzien: </p> <p>
     <code> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Trait-gegevens kunnen worden opgemaakt als sleutelwaardeparen met alfanumerieke tekenreeksen. Er zijn verschillende manieren om sleutelwaardeparen op te maken, zoals hieronder wordt getoond: </p> <p> 
     <ul id="ul_D4F5A97FE0444AC6B7D8D4DAEDD3EAF2"> 
      <li id="li_07B893AA8EB24F34B70F8DA06E87EAB3"> <code> key = value </code> </li> 
      <li id="li_1F3ACA27C5794931B430298B27AB8BCC"> <code> "key" = value </code> </li> 
      <li id="li_8910539EB4F0431E8CF63983D30D9B08"> <code> key = "value" </code> </li> 
      <li id="li_DCECE281D245438FB01F8D0BA932B3CC"> <code> "key" = "value" </code> </li> 
     </ul><code> "age"="32" </code> , <code> "gender"=m </code> , <code> model = "pickup truck" </code> , <code> product = tablet </code> zijn voorbeelden van correct opgemaakte sleutel-waardeparen. </p> </td> 
  </tr>
 </tbody>
</table>
...
[!UICONTROL Trait IDs] bestaat alleen uit numerieke tekens. Wij vragen u om *slechts[!UICONTROL onboarded traits]* in binnenkomende gegevensdossiers op te nemen. Andere [!UICONTROL trait] -typen in de binnenkomende gegevensoverdracht worden niet verwerkt.
...
<table id="table_8C5C7271B813441EA2D45CA2FE2A6C59"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><i> gebruik niet </i> een gecodeerde dubbelepunt ( <code> %3A </code>) of uncoded dubbelpunt (:) symbool in DPUUIDs. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Mobiele apparaat-id's moeten strikt zijn opgemaakt zoals hieronder wordt weergegeven: </p> <p> 
     <ul id="ul_6AEFB6CFA54444D9B75F03BCE7916696"> 
      <li id="li_45B272D5EEE944FC9D5C89A0924465F7">IDFA-indeling: id's moeten hoofdletters en kleine letters zijn en geen hashed. Bijvoorbeeld: <code> 6D92078A-8246-4BA4-AE5B-76104861E7DC </code> </li> 
      <li id="li_2DA0347293814C70ADCD253BF01A81F5">Android-indeling: id's moeten kleine letters zijn en geen hashing. Bijvoorbeeld: <code> 97987bca-ae59-4c7d-94ba-ee4f19ab8c21 </code> </li> 
     </ul> </p> </td>
  </tr>
 </tbody>
</table>
...
<table id="table_8017E070F7A54143A82CA153CBAEB5DA"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Deze kenmerken zijn toegevoegd aan een regel met kenmerk <code> ic </code> prefix. Als zodanig kunt u ze toevoegen aan het gegevensbestand, gescheiden door komma's, zoals getoond. Een tabblad scheidt de UUID en de eigenschap-id's. Het voorvoegsel <code> ic </code> is niet vereist in het bestand. </p> <p><b> Numerieke IDs </b> </p> <p> 
     <code>
       DBwFoc3dhfMNCFBh2M4F9ZkJEXMNnRDh2PXvnI1&amp;nbsp;&amp;nbsp;30608,50354,50338,50352,30626 
     </code> </p> <p><b> identiteitskaart van het Koord </b> </p> <p> 
     <code>
...
Gebruik [!UICONTROL trait IDs] om [!UICONTROL trait] kwalificatiegegevens voor [!DNL Audience Manager] [!DNL UUIDs] te verzenden.
...
Met [!UICONTROL trait IDs] kunt u [!UICONTROL trait] informatie over diskwalificatie verzenden voor [!DNL Audience Manager] [!DNL UUIDs] .
...
Verzenden in sleutel-waardeparen om [!UICONTROL trait] kwalificatiegegevens voor [!DNL Audience Manager] [!DNL UUIDs] toe te voegen.
...
Gebruik het voorvoegsel `ic` om [!UICONTROL trait] kwalificatiegegevens voor [!DNL Audience Manager] [!DNL UUIDs] te verzenden.
...
Gebruik [!UICONTROL trait IDs] om [!UICONTROL trait] diskwalificatiegegevens voor [!DNL Android] -apparaten te verzenden.
...
Verzenden in sleutelwaardeparen om [!UICONTROL trait] kwalificatiegegevens voor [!DNL Android] -apparaten toe te voegen.
...
Gebruik het voorvoegsel `ic` om [!UICONTROL trait] kwalificatiegegevens voor [!DNL Android] -apparaten te verzenden.
...
Gebruik [!UICONTROL trait IDs] om [!UICONTROL trait] diskwalificatiegegevens voor [!DNL iOS] -apparaten te verzenden.
...
Verzenden in sleutelwaardeparen om [!UICONTROL trait] kwalificatiegegevens voor [!DNL iOS] -apparaten toe te voegen.
...
Gebruik het voorvoegsel `ic` om [!UICONTROL trait] kwalificatiegegevens voor [!DNL iOS] -apparaten te verzenden.
...
Gebruik [!UICONTROL trait IDs] om [!UICONTROL trait] kwalificatiegegevens voor [!DNL DPUUIDs] te verzenden.
...
Gebruik [!UICONTROL trait IDs] om [!UICONTROL trait] diskwalificatiegegevens voor [!DNL DPUUIDs] te verzenden.
...
Verzenden in sleutel-waardeparen om [!UICONTROL trait] kwalificatiegegevens voor [!DNL DPUUIDs] toe te voegen.
...
Gebruik het voorvoegsel `ic` om [!UICONTROL trait] kwalificatiegegevens voor [!DNL DPUUIDs] te verzenden.
