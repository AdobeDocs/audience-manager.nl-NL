...
<table id="table_B2825B7BE0DB4665B47C589A3787CD93"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Selecteer <b><span class="uicontrol"> Enable file error sampling</span></b> wanneer u problemen met binnenkomende dossierverwerking moet oplossen. Deze functie genereert een foutvoorbeeldrapport waarin u bestandsindelingen en syntaxisfouten kunt zien. </p> <p>Zie <a href="../reporting/onboarding-status-report.md#onboarding-status-about"> Rapport over status aan boord: Informatie</a> over foutrapportage en foutsampling. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_82FEFA8DC8294FA18FB4C17F02DF5152"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>De gegevensbron voor meerdere apparaten bevat een geverifieerde id. Een geverifieerde id wordt tijdens een verificatiegebeurtenis verzameld en gesynchroniseerd met een <span class="keyword"> Audience Manager</span> -id (een gebruiker kan zich bijvoorbeeld on-site, in-app enz. aanmelden). De geverifieerde id kan worden gebruikt voor gegevens aan boord van andere bronnen die deze id opslaan. Het kan ook worden gebruikt om veelvoudige apparaat IDs in de Verbinding <span class="wintitle"> van het</span>Profiel te verbinden. </p> <p>Met deze optie wordt een tekstveld weergegeven waarin u de naam van de gegevensbron kunt wijzigen in een alias. Als u een alias gebruikt, treedt deze nieuwe naam de gegevensbronnaam met voeten en verschijnt in de <span class="wintitle"> Voor authentiek verklaarde Opties</span> van het Profiel wanneer u een regel <a href="../features/profile-merge-rules/merge-rules-start.md#create-profile-merge-rule"> van de Fusie van het Profiel</a>creeert. </p> </td> 
  </tr> 
  <tr> 
