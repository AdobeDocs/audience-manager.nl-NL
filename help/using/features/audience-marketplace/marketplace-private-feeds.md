...
Klik op de naam van een persoonlijke gegevensfeed vanuit [!UICONTROL My Shared Data] Hiermee gaat u naar een pagina die meerdere tabbladen bevat. Klik op een tabblad om uw persoonlijke aanvragen voor gegevenstoevoer te beheren.
...
<table id="table_AFB429CA52A34658859448D9A5215F9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Hiermee geeft u nieuwe abonnementsaanvragen voor een persoonlijke gegevensfeed weer. Klik op dit tabblad om kopersaanvragen te bekijken, goed te keuren of af te wijzen. </p>
    <ul id="ul_BE0A835A90B14C05B3F63226B79D052D"> 
     ...
     <li id="li_929591FCF81E43A3881813BDBD3AC278">Afgewezen kopers worden verplaatst naar <b><span class="uicontrol"> Afgewezen toegang</span></b>. </li>
    </ul> </td>
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Hiermee geeft u afgewezen abonnementsaanvragen voor een privégegevensfeed weer. </p> <p>Als u afgewezen kopers opnieuw wilt goedkeuren, wijzigt u de optie <span class="wintitle"> Afwijzingsstatus</span> tot <b><span class="uicontrol"> Toestaan</span></b>. Hiermee wordt de koper verplaatst naar <b><span class="uicontrol"> Potentiële abonnees</span></b>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [Een openbare of persoonlijke gegevensfeed maken](../../features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#create-public-private-data-feed)
* [Verzoeken om persoonlijke feed controleren, goedkeuren of afwijzen](../../features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#manage-private-requests)
...
Als koper worden privégegevensfeeds weergegeven in de [Marketplace](../../features/audience-marketplace/marketplace-data-buyers/marketplace-data-buyers.md#about-marketplace) zoals elk ander voorstel. In dit geval bevat de lijst met feed echter geen samenvattingsinformatie voor kenmerken, unieke gebruikers en overlappende gebruikers. De gegevensverkoper beschikt ook over een optie om de naam ervan weer te geven of te verbergen in het dialoogvenster [!UICONTROL Provider] kolom van de [!UICONTROL Marketplace] lijst. Nadat de verkoper uw abonnementsaanvraag heeft goedgekeurd, worden alle gegevens in een privéfeed beschikbaar voor jou (het werkt net als een openbare feed). De [!UICONTROL Marketplace] In het onderstaande voorbeeld worden de drie verschillende typen voer weergegeven die je als koper kunt gebruiken.
...
<table id="table_41D4A798ACF548A3A03ACB427CA4652D"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><b><span class="uicontrol"> Private zonder branding</span></b> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p><b><span class="uicontrol"> Private met branding</span></b> </p> </td> 
...
Zie [Abonneren op een privégegevensfeed](../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#subscript-private-data-feed) om toegang aan te vragen.
...
Meer informatie over [eigenschappen maken](/help/using/features/traits/create-onboarded-rule-based-traits.md) en [bewerkingskenmerken](/help/using/features/traits/manage-trait-rules.md#edit-trait).

### Stap 4 - Gegevensaanbieder - Gegevensfeed maken

Maak vervolgens een gegevensfeed om uw kenmerken te delen met de koper van de gegevens. Zie [Een openbare of persoonlijke gegevensfeed maken](/help/using/features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md) voor instructies over het maken van een gegevensfeed.
...
Ga naar **Audience Marketplace > Marketplace**. Zoek naar de gegevensvoer die door de gegevensleverancier in de vorige stap wordt gecreeerd. Klikken **Toegang aanvragen**. De aangewezen contactpersoon van de gegevensleverancier ontvangt nu een e-mailbericht. Zie ook: [Abonneren op een privégegevensfeed](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#subscript-private-data-feed).

### Stap 6 - Gegevensaanbieder - Toegang verlenen

Ga naar **Audience Marketplace > Mijn gedeelde gegevens** en zoek naar de feed die u in stap 4 hebt gemaakt. Klik in het nieuwe toegangsverzoek en klik op **Toegang toestaan** om het verzoek goed te keuren. Zie ook: [Verzoeken om persoonlijke feed controleren, goedkeuren of afwijzen](/help/using/features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#manage-private-requests).

### Stap 7 - Koper van gegevens - Abonnement inschakelen

Nadat de gegevensaanbieder toegang verleent tot de gegevensfeed, kunt u de feed in uw account bekijken in **Audience Marketplace > Marketplace**. Controleer de details, schakel de knoop van het Abonnement aan, en klik **Reviseren en abonneren**. Zie [Opslag voor geabonneerde gegevensfeeds](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#find-subscribed-data-fee) voor informatie over waar de eigenschappen van derden te vinden zijn.
