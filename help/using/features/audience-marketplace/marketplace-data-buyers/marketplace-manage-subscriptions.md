...
1. Klik op de naam van de gegevensfeed in het [!UICONTROL Marketplace]dialoogvenster.
1. Klik op **[!UICONTROL Request Access]**. Hiermee wordt het dialoogvenster Verzoek geopend.
1. Schrijf in het dialoogvenster Verzoek een notitie die uw interesse in de gegevensinvoer uitdrukt en klik op **[!UICONTROL Send]**. De verkoper zal je bericht bekijken en je aanvraag goedkeuren of afwijzen. Tijdens het wachten op goedkeuring wordt &#39;&#39;Gevraagd&#39;&#39; weergegeven in de [!UICONTROL Marketplace] lijst voor die gegevensinvoer.
...
In [!UICONTROL Audience Marketplace]dat geval kunnen providers kopers een korting bieden op de gepubliceerde prijs van een [!DNL CPM] of forfaitaire gegevensinvoer. Kortingsbedragen zijn echter niet zichtbaar voor kopers in de lijst met [!DNL Marketplace] diervoeders. Maar u kunt ook om een korting vragen wanneer u zich abonneert op een persoonlijke gegevensfeed of wanneer u meer informatie over een bepaalde feed aanvraagt.
...
<table id="table_3C6E58F593BA48EC89ACBD9A26E4E74F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Als u al bent geabonneerd op een persoonlijke gegevensfeed en een korting wilt aanvragen: </p> 
    <ol id="ol_A58D419EBB9349E9B1225202535130F6"> 
     ...
     <li id="li_B1B5AA6F6CC64512A02D5E8861A5F266">Als de provider u een korting geeft, moet u zich opnieuw abonneren op de feed op de<sup>eerste</sup> dag van de volgende maand. </li> 
    </ol> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Een <a href="../../../features/audience-marketplace/marketplace-private-feeds.md"> potentiële abonnee</a> is een gegevenskoper die toegang heeft aangevraagd tot een persoonlijke gegevensfeed, goedkeuring van de verkoper heeft ontvangen, maar zich niet op de feed heeft geabonneerd. Om een korting als potentiële abonnee aan te vragen: </p> 
    <ol id="ol_9CECDA92E7894B20AC8A777D78962188"> 
     ...
     <li id="li_763C050AC9464BE380D00F6085B6E540">Klik op Meer informatie <b><span class="uicontrol"></span></b>aanvragen. Vraag om een korting in je verzoek om details aan de verkoper. </li> 
    </ol> </td> 
  </tr> 
 </tbody> 
</table>
...
1. Kijk naar de [!UICONTROL Price] en de [!UICONTROL Your Price] kolommen in de [!UICONTROL Plan Details] tabel. Als het diervoeder wordt gedisconteerd:

   * De oorspronkelijke prijs wordt met een rode lijn gemarkeerd.
   * De vergoeding in de [!UICONTROL Your Price] kolom is lager dan de vergoeding in de [!UICONTROL Price] kolom.

In het voorbeeld krijgt de koper een korting van 10% op het [!UICONTROL Segments and Overlap] abonnement in het **[!UICONTROL Software Audience Feed]** voorbeeld.

![](assets/buyer-discount.png)

## Geabonneerde feeddata zoeken {#find-subscribed-data-fee}

De gegevens (kenmerken) voor uw gegevensfeeds worden weergegeven in hun eigen opslagmappen voor de eigenschap. Ga naar **[!UICONTROL Audience Data > Traits]** en breid de **[!UICONTROL 3rd-Party Data]** omslag uit om de eigenschappen in uw geabonneerde voer te bekijken en te werken. Zoek de submap die naar de gegevensaanbieder is genoemd. Die bevatten mappen die worden genoemd naar de afzonderlijke gegevensfeed en lijstkenmerken die door de feed worden verschaft.
...
Gegevens die kopers afmelden van gegevensfeeds en plannen in **[!UICONTROL Audience Marketplace > Marketplace]**.
...
1. Klik op de naam van de gegevensfeed in het [!UICONTROL Marketplace]dialoogvenster.
1. Zoek in de [!UICONTROL Use Case] sectie het plan dat u wilt gebruiken en verplaats de **[!UICONTROL Subscription]** schuifregelaar naar **[!UICONTROL Off]**.
...
* **Inactieve verkopers:** De leveranciers van gegevens die verlaten [!UICONTROL Audience Marketplace] zullen al hun gegevensvoer deactiveren en schrappen.
...
* Bulkverwijdering met de [REST API&#39;s](../../../api/rest-api-main/rest-api-main.md) of de [Bulk Management Tools](../../../reference/bulk-management-tools/bulk-management-intro.md).

* Zoek handmatig naar betrokken segmenten en verwijder gedeactiveerde kenmerken met behulp van [!UICONTROL Segment Builder]. Zie Traits [verwijderen uit een segment](../../../features/segments/segment-builder.md#segment-builder-controls-traits).
...
1. De knoppen Informatie plannen.
   * Klik **[!UICONTROL Explore All Traits]** om details over alle eigenschappen in de geselecteerde gegevensinvoer te zien.
...
1. **[!UICONTROL Plan Details]** Tabel. Deze lijst toont u de gebruiksgevallen die u aan het gegeven voor, evenals zijn het tariferen model kunt intekenen. Zie [Gevallen](#use-cases)van het Gebruik van gegevensvoer begrijpen.
...
1. Knoppen voor het uitvoeren van acties plannen.
   ...
   * Klik **[!UICONTROL Review & Subscribe]** om u te abonneren op een gegevensfeed. Deze knop wordt grijs weergegeven totdat u een [!UICONTROL Subscription] schakeloptie inschakelt [!UICONTROL On]. Zie ook [aan een Openbare Diervoed](#subscript-public-data-feed) van Gegevens intekenen en [aan een Privé Diervoed](#subscript-private-data-feed)van Gegevens intekenen.
