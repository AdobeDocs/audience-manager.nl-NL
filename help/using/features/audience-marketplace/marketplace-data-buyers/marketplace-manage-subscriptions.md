...
De [!UICONTROL Marketplace] is waar de gegevenskopers naar onderzoek gaan en aan openbare en privé gegevensvoer intekenen. Voer de volgende stappen uit om u te abonneren op een openbare gegevensfeed.

## Abonneren op een Public Data Feed {#subscript-public-data-feed}
...
1. Klik op de naam van de gegevensfeed die u wilt gebruiken. Hiermee opent u de pagina [plandetails](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#marketplace-buyer-details) voor de geselecteerde feed.
...
1. Kies een gebruiksscenario in de tabel met abonnementen en:
   ...
   * Klik op **[!UICONTROL Review & Subscribe]**. Hiermee opent u het venster [!UICONTROL Terms and Conditions].

   ![inschrijven](assets/subscribe3.png)

1. In het venster [!UICONTROL Terms and Conditions]:
   ...
   * Schakel het vakje voor de voorwaarden in en klik op **[!UICONTROL Accept]** om het abonnementsproces te voltooien.
...
1. Er is geen garantie dat de gegevenssets elkaar overlappen. Voor een overlapping om geldig te zijn, moet een gebruiker van de gegevensreeks van de klant met de gegevens worden geassocieerd
...
Kopers abonneren zich op privégegevensfeeds en -plannen in **[!UICONTROL Audience Marketplace > Marketplace]**.
...
1. Klik op de naam van de gegevensfeed in [!UICONTROL Marketplace].
...
1. Schrijf in het dialoogvenster Verzoek een notitie die uw interesse in de gegevensinvoer uitdrukt en klik op **[!UICONTROL Send]**. De verkoper zal je bericht bekijken en je aanvraag goedkeuren of afwijzen. Tijdens het wachten op goedkeuring wordt &#39;&#39;Gevraagd&#39;&#39; weergegeven in de lijst [!UICONTROL Marketplace] voor die gegevensinvoer.
   ...
   * **[!UICONTROL Request approved]**: De status in de  [!UICONTROL Marketplace] lijst verandert in &quot;Toegang verleend&quot;en u zult een geautomatiseerd bericht ontvangen. Op dit punt kunt u zich abonneren op de feed. Zie [Abonneren op een Public Data Feed](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#subscript-public-data-feed) voor instructies.
   * **[!UICONTROL Request denied]**: De tekst &quot;Gevraagd&quot; wordt verwijderd uit de  [!UICONTROL Marketplace] lijst voor de feed. U kunt proberen opnieuw te abonneren of een andere feed kiezen.

## Kortingen gegevensfeed voor kopers {#buyer-discount}

In [!UICONTROL Audience Marketplace] kunnen providers kopers een korting bieden op de gepubliceerde prijs van een [!DNL CPM]- of forfaitaire gegevensfeed. Kortingsbedragen zijn echter niet zichtbaar voor kopers in de voederlijst [!DNL Marketplace]. Maar u kunt ook om een korting vragen wanneer u zich abonneert op een persoonlijke gegevensfeed of wanneer u meer informatie over een bepaalde feed aanvraagt.
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Als u al bent geabonneerd op een persoonlijke gegevensfeed en een korting wilt aanvragen: </p> 
    <ol id="ol_A58D419EBB9349E9B1225202535130F6"> 
     <li id="li_D0DDC8AC6E9C4675AA4630D63FE8F071"> <a href="../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#unsubscribe"> Abonnement </a> op de gegevensinvoer opzeggen. </li> 
     <li id="li_05A5379F2A944FB28AB39C196DDE3A1D">Neem contact op met de gegevensaanbieder en vraag om een korting. </li> 
     <li id="li_B1B5AA6F6CC64512A02D5E8861A5F266">Als de leverancier u een korting geeft, re-subscribe aan het voer op 1<sup>st</sup> dag van de volgende maand. </li> 
    </ol> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <b>Nieuwe abonnees voor Private Data Feed</b> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Een <a href="../../../features/audience-marketplace/marketplace-private-feeds.md"> potentiële abonnee</a> is een gegevenskoper die om toegang tot een privé gegevensvoer heeft verzocht, goedkeuring van de verkoper heeft ontvangen, maar niet op het voer heeft geabonneerd. Om een korting als potentiële abonnee aan te vragen: </p> 
    <ol id="ol_9CECDA92E7894B20AC8A777D78962188"> 
     ...
     <li id="li_763C050AC9464BE380D00F6085B6E540">Klik <b><span class="uicontrol"> verzoek om meer details</span></b>. Vraag om een korting in je verzoek om details aan de verkoper. </li> 
    </ol> </td> 
  </tr> 
 </tbody> 
</table>

## Discount feeds {#review-discounted-feeds} controleren
...
1. Bekijk de [!UICONTROL Price] en [!UICONTROL Your Price] kolommen in [!UICONTROL Plan Details] lijst. Als het diervoeder wordt gedisconteerd:
...
De gegevens (kenmerken) voor uw gegevensfeeds worden weergegeven in hun eigen opslagmappen voor de eigenschap. Ga naar **[!UICONTROL Audience Data > Traits]** en breid **[!UICONTROL 3rd-Party Data]** omslag uit om de eigenschappen in uw geabonneerde voer te bekijken en te werken. Zoek de submap die naar de gegevensaanbieder is genoemd. Die bevatten mappen die worden genoemd naar de afzonderlijke gegevensfeed en lijstkenmerken die door de feed worden verschaft.

<!-- marketplace-feed-storage.xml -->

![](assets/subscribe5.png)

## Abonnement op een gegevensfeed {#unsubscribe} opzeggen
...
1. Klik op de naam van de gegevensfeed in [!UICONTROL Marketplace].
1. Zoek in de sectie [!UICONTROL Use Case] het plan dat u wilt gebruiken en verplaats de **[!UICONTROL Subscription]** schuifregelaar naar **[!UICONTROL Off]**.

## Deactivering van gegevensfeed: Waarom het gebeurt en hoe te om {#data-feed-deactivation-reasons} te antwoorden
...
* **Facturering:** Gegevensproviders deactiveren een feed als je altijd te laat bent met betaling van vergoedingen of als je je kosten niet betaalt.
* **Updates van feed:** gegevensleveranciers moeten feeds deactiveren wanneer zij hun diervoedertaxonomie of kostenstructuur bijwerken.
* **Inactieve kopers:** Gegevensleveranciers behouden zich het recht voor om feeds te deactiveren als abonnees gedurende een langere periode geen uitgaven tonen.
* **Inactieve verkopers:** Gegevensleveranciers die verlaten  [!UICONTROL Audience Marketplace] zullen al hun gegevensvoer deactiveren en schrappen.
...
## E-mail {#deactivation-email} deactiveren

Wanneer een gegevensaanbieder een van uw gegevensfeeds deactiveert, verzendt [!DNL Audience Manager] een e-mail naar de gebruikers in uw bedrijf die [!UICONTROL Administrator] toestemmingen hebben. Soms wordt dit bericht door e-mailfilters geclassificeerd als spam. Dit kan ertoe leiden dat u deze belangrijke melding mist. Om u te helpen het deactiveringsbericht identificeren, bevat dit e-mailbericht de volgende elementen:

* **Van:** De deactiveringse-mail komt van  `aam-noreply@adobe.com`. Pro-tip: Beantwoord deze e-mail niet.

* **Onderwerpregel:** Abonnement op  *naam van gegevensfeed* is geannuleerd.

* **Bijlagen:** Het e-mailbericht bevat een bijlage met de naam &quot;  `list-of-affected-entities-by-feed-revocation.csv`.&quot; Dat is een geconvolueerde manier om te zeggen dat de bijlage alle kenmerken vermeldt die in de geannuleerde feed zijn opgenomen. Als koper van gegevens kun je deze bijlage bekijken. Het zal u helpen gedeactiveerde eigenschappen van uw segmenten en [algoritmische modellen vinden en verwijderen](../../../features/algorithmic-models/understanding-models.md).

## Gedetactiveerde lijst {#deactivation-trait-list}
...
<table id="table_5C3800F9D8AA43EFAB4690959A721F63"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>De id van het algoritmische model dat gedeactiveerde kenmerken bevat. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><b><span class="uicontrol"> Naam algomodel</span></b> </p> </td> 
   <td colname="col2"> <p>De namen van algoritmische modellen die gedeactiveerde eigenschappen bevatten. </p> </td> 
  </tr> 
 </tbody> 
</table>

## Gedetactiveerde treinstellen verwijderen {#remove-deactivated-traits}
...
* Bulkverwijdering met de [REST API&#39;s](../../../api/rest-api-main/rest-api-main.md) of [Bulk Management Tools](../../../reference/bulk-management-tools/bulk-management-intro.md).

* Zoek handmatig naar betrokken segmenten en verwijder gedeactiveerde kenmerken met [!UICONTROL Segment Builder]. Zie [Traits verwijderen uit een segment](../../../features/segments/segment-builder.md#segment-builder-controls-traits).
...
[Abonnement op de gedeactiveerde gegevens opzeggen nadat u alle ingetrokken ](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#unsubscribe) kenmerken van uw account hebt verwijderd. Als dit een tijdelijke deactivering is, kunt u zich opnieuw abonneren nadat de gegevensaanbieder de vereiste wijzigingen heeft aangebracht en de feed opnieuw heeft geactiveerd. Zoals bij de meeste zaken, kan de goede communicatie met uw partners (de gegevensleverancier en [!DNL Adobe]) u helpen door dit proces werken.

## De pagina met abonnementsdetails in Audience Marketplace {#marketplace-buyer-details}

Wanneer u op de naam van een gegevensabonnement in [!UICONTROL Marketplace] klikt, biedt [!DNL Audience Manager] informatie die u kan helpen geïnformeerde keuzes te maken over het abonneren op een gegevensfeed.
...
1. De knoppen Informatie plannen.
   * Klik **[!UICONTROL Explore All Traits]** om details over alle eigenschappen in de geselecteerde gegevensvoer te zien.
   * Klik **[!UICONTROL Request More Details]** om de gegevensleverancier vragen over de geselecteerde gegevensvoer te stellen of om een korting te verzoeken. Met deze functie worden uw opmerkingen en vragen rechtstreeks naar de gegevensaanbieder verzonden.

1. Gegevensinvoer rapporteert statistieken. In het Venn-diagram (en de bijbehorende maatstaven) ziet u overlappende gegevens voor de laatste 30 dagen. Zie [De Marketplace: Informatie over](marketplace-data-buyers.md#about-marketplace) voor meer informatie.
   * **[!UICONTROL 30 Day Overlapped Uniques]**: Het aantal unieke gebruikers in uw account dat de gebruikers in de account van de provider overlappen. Voor een definitie van unieke gebruikers, zie AAM UUID in [Index van IDs in Audience Manager](/help/using/reference/ids-in-aam.md).
...
1. **[!UICONTROL Plan Details]** Tabel. Deze lijst toont u de gebruiksgevallen die u aan het gegeven voor, evenals zijn het tariferen model kunt intekenen. Zie [Gevallen voor het gebruik van gegevensfeed](#use-cases) begrijpen.

1. Knoppen voor het uitvoeren van acties plannen.
   * Klik **[!UICONTROL Cancel]** om de pagina te verlaten zonder veranderingen aan te brengen.
   * Klik op **[!UICONTROL Review & Subscribe]** om u in te schrijven op een gegevensfeed. Deze knop wordt grijs weergegeven totdat u een [!UICONTROL Subscription]-schakeloptie instelt op [!UICONTROL On]. Zie ook [Abonneren op een Public Data Feed](#subscript-public-data-feed) en [Abonneren op een Private Data Feed](#subscript-private-data-feed).

## Gevallen {#use-cases} voor gebruik van gegevensfeed

Als [!UICONTROL Audience Marketplace] gegevenskoper, kunt u gegevens voor overlapping, modellering, en activeringsgebruiksgevallen kopen. Elk gebruiksgeval wordt ontworpen voor een specifiek doel en beperkt wat u met de gegevens kunt doen. Deze gebruiksgevalbeschrijvingen kunnen u helpen het juiste besluit nemen over welk type van gegevensplan te kopen.
...
Met dit gebruiksgeval kunt u uw kenmerken vergelijken met de providerkenmerken in een [overlap-rapport met kenmerk-to-trait.](../../../reporting/dynamic-reports/trait-trait-overlap-report.md#trait-to-trait-overlap-report) Ook, kunt u leverancierseigenschappen tot stand brengen of toevoegen aan een segment en extra vergelijkingen met  [segment-aan-](../../../reporting/dynamic-reports/segment-trait-overlap-report.md) traitand  [segment-aan-](../../../reporting/dynamic-reports/segment-segment-overlap-report.md) segmentrapporten maken. Met behulp van overlap-vergelijkingen kunt u:

* **Breid publieksbereik uit:** Lage overlapping stelt voor dat uw kenmerken gebruikers bevatten die u nog niet eerder hebt gezien. U kunt deze kenmerken gebruiken om nieuwe gebruikers te proberen te bereiken.
* **Verbeteren van het bestaande publiek:** Hoge overlapping geeft aan dat uw kenmerken vergelijkbaar zijn met die van de gegevensaanbieder. U wilt deze kenmerken wellicht gebruiken om een doelgericht, stapsgewijs verbeterd publiek te helpen maken.

### Algorithmic Models

Met dit gebruiksgeval kunt u de eigenschappen van de leverancier vergelijken met uw kenmerken met [algoritmische modellering](../../../features/algorithmic-models/understanding-models.md#understanding-models). Ons algoritmisch modelleringssysteem gebruikt bijvoorbeeld een van uw kenmerken als basis voor vergelijking met een leverancierstaak. Wanneer het model wordt uitgevoerd, kan worden getoond of het publiek in leverancierssporen gelijkaardige omzettingsattributen aan uw eigenschappen deelt.

### Activering

Met dit gebruiksgeval kunt u gegevens naar een [doel](../../../features/destinations/destinations.md) verzenden. In [!DNL Audience Manager] is een doel een systeem van derden (ad-server, [!DNL DSP], [!DNL DMP], exchange, enz.) waarmee u data wilt delen. Met een [!UICONTROL Activation]-gebruiksscenario kunt u echter geen overlappende rapporten uitvoeren of de gegevens in een algoritmisch model testen.
...
>* [Abonneren op een openbare gegevensfeed](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#subscript-public-data-feed)
...
>* [De markt: Info](../../../features/audience-marketplace/marketplace-data-buyers/marketplace-data-buyers.md#about-marketplace)
