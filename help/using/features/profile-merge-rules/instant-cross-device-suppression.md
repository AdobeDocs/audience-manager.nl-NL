...
1. Pas frequentiecontroles op de tweede eigenschap toe. Desgewenst kunt u ook de instellingen voor de frequentie toevoegen. Lees meer over [&#x200B; hoe te om recentie en frequentiecontroles &#x200B;](../segments/recency-and-frequency.md) toe te passen.
1. Wijs het segment aan om het even welk aantal server-aan-server bestemmingen in real time toe. Lees over hoe te om segmenten aan [&#x200B; server-aan-server bestemmingen &#x200B;](../destinations/add-edit-segments.md) toe te voegen.
