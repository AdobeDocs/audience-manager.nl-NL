...
Neem contact op met uw Adobe als u deze premiumfunctie wilt gebruiken.

## Partner-specifieke vereisten {#partner-prerequisites}

### [!DNL Facebook] {#facebook}

Wat u moet doen [!UICONTROL People-Based Destinations] om uw eerste publiek te verzenden [!UICONTROL segments] tot [!DNL Facebook]voldoet aan de volgende vereisten:
...
Wat u moet doen [!UICONTROL People-Based Destinations] om uw segmenten van het eerste publiek naar te sturen [!DNL LinkedIn], zorg ervoor dat uw [!DNL LinkedIn Campaign Manager] account bevat [!DNL Creative Manager] of hoger machtigingsniveau.
...
>[!IMPORTANT]
>
>Alle klanten van Audience Managers kunnen gehashte e-mails opnemen zonder zich aan te melden voor [!UICONTROL People-Based Destinations].

Gegevensinvoer voor [!UICONTROL People-Based Destinations] ondersteunt momenteel maximaal 10 gehashte e-mailadressen gekoppeld aan één klant-id ([!DNL CRM ID]), per partij.
...
Om hashed-id&#39;s in te voeren, [een apparaatgegevensbron voor hashed-id&#39;s maken](../create-data-source-hashed-emails.md) en de **[!UICONTROL Share associated cross-device IDs in people-based destinations and/or hashed email workflows]** -optie.

![UI-afbeelding van Audience Manager waarin de optie wordt weergegeven om gekoppelde id&#39;s voor verschillende apparaten te delen in op personen gebaseerde doelen en/of gehashte e-mailworkflows](assets/data-source-share-ids.png)

## Gegevensprivacy {#data-privacy}

Hoewel [!UICONTROL People-Based Destinations] zodat u doelgroepen kunt kiezen op basis van gehashte e-mailadressen die door u zijn geüpload, kunt u nog steeds geen rechtstreeks identificeerbare bezoekersgegevens naar de Audience Manager uploaden. In de gegevensinstapfase moet u ervoor zorgen dat de e-mailadressen die u wilt gebruiken, worden gehasht met de [!DNL SHA256] algoritme. Anders kunt u ze niet gebruiken in [!UICONTROL People-Based Destinations].
...
Hashing is een eenrichtingsfunctie die de invoer roteert om een uniek resultaat te produceren. Door juiste hash-algoritmen te gebruiken, zoals [!DNL SHA256], is er geen manier om de hashing functie om te keren en de onverstrooide informatie te onthullen. De e-mailadressen die u aan boord aan Audience Manager gaat, moeten met de [!DNL SHA256] algoritme. Op deze manier kunt u ervoor zorgen dat er geen ongehashte e-mailadressen bij de Audience Manager terechtkomen.
