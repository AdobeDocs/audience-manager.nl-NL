---
description: Een lijst van nieuwe of herziene documenten die in 2018 en voorgaande jaren zijn gepubliceerd. Bevat kleine updates van de documentatie van Audience Manager die mogelijk niet worden behandeld in de Opmerkingen bij de release Experience Cloud.
seo-description: Een lijst van nieuwe of herziene documenten die in 2018 en voorgaande jaren zijn gepubliceerd. Bevat kleine updates van de documentatie van Audience Manager die mogelijk niet worden behandeld in de Opmerkingen bij de release Experience Cloud.
...
Een lijst van nieuwe of herziene documenten die in 2018 en voorgaande jaren zijn gepubliceerd. Bevat kleine updates van de documentatie van Audience Manager die mogelijk niet worden behandeld in de Opmerkingen bij de release Experience Cloud.
...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Voor klanten die Audience Manager en Adobe Analytics gebruiken: De interface van de Manager van de Publiek staat u niet toe om gegevensbronnen te schrappen die automatisch van uw het rapportreeksen van Analytics worden gecreeerd. Gebruik de <a href="https://marketing.adobe.com/resources/help/en_US/mcloud/" format="https" scope="external"> Dienst</a> van de Kern om deze gegevensbronnen unmap. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vanaf versie 8.0 is <span class="wintitle"> DIL</span> sterk afhankelijk van de <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, versie 3.3 of hoger. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> De Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p>Gewijzigd <a href="../dil/dil-overview.md"> Getting and Implementation DIL Code</a> om rekening te houden met het feit dat <span class="keyword"> Adobe Experience Platform Launch</span> het voorkeursprogramma voor code-implementatie in de <span class="keyword"> Experience Cloud</span>is. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_728845C945394BCC8689ACF50EDDB577"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>De Optimalisering van het publiek voor Uitgevers kan u helpen potentiële prestatiemogelijkheden voor de segmenten van de Manager van de Publiek op uw bezeten en in werking gestelde inhoud identificeren. Deze rapporten combineren de gegevens van campagneresultaten op logboekniveau met de metriek van de Manager van de Publiek om publieksoptimalisaties en monetiseringskansen te informeren. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../reporting/audience-optimization-reports/aor-publishers/import-dfp.md"> DFP-gegevensbestanden importeren in Auditions Manager</a> </p> </td> 
   <td colname="col2"> <p>Voordat Audience Manager de optimalisatie van het publiek voor uitgevers kan inschakelen, moet u ervoor zorgen dat aan alle voorwaarden die in dit artikel worden beschreven, wordt voldaan. Neem contact op met de klantenservice nadat u alle voorwaarden hebt gecontroleerd. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_2D7B56FFB0134D18894E0493043C32BD"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Voordat we de specificaties van Audience Manager lezen, raden we u aan het materiaal van Experience Cloud voor de Europese algemene gegevensbeschermingsverordening (GDPR), dat op deze pagina is gekoppeld, te doorlopen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../overview/data-security-and-privacy/data-privacy-requests.md"> GDPR in Audience Manager</a> </p> </td> 
   <td colname="col2"> <p>In dit document worden de technische details besproken die verband houden met de algemene gegevensbeschermingsverordening (GDPR) voor Audience Manager en wordt uitgelegd hoe u GDPR-verzoeken kunt indienen bij Audience Manager. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../overview/data-security-and-privacy/aam-gdpr-glossary.md"> Veelgestelde vragen over GDPR</a> </p> </td> 
   <td colname="col2"> <p>Dit materiaal bevat een aantal van de meest voorkomende vragen die door onze klanten en partners zijn gesteld met betrekking tot de Europese algemene gegevensbeschermingsverordening (GDPR) en hoe Adobe Audience Manager als gegevensprocessor tegemoetkomt aan verschillende GDPR-vereisten. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../overview/data-security-and-privacy/aam-gdpr-partners.md"> GDPR Partner Unsegment</a> </p> </td> 
   <td colname="col2"> <p>Om onze klanten te helpen GDPR- verzoeken automatiseren, brengt de Manager van de Publiek onze activeringspartners op de hoogte over schrappingsverzoeken van de Onderwerpen van Gegevens door hen te verzenden unsegment (of segment) informatie te verwijderen. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_F2018CE3F64E4A1FAA9289EEA17D4E4D"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vanaf 29 maart 2018 moeten alle klanten van Audience Manager die op <a href="https://www.ampproject.org/learn/overview/" format="https" scope="external"> versnelde mobiele pagina</a> 's (AMP) werken, de integratie aan de serverzijde benutten wanneer ze een publiek naar Google’s DoubleClick for Publishers (DFP) sturen. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-qualification-reference.md#unique-trait-realizations"> Unieke realisaties van sporen en totale populatie van trekkers</a> </p> </td> 
...
<table id="table_D45F5EA38F88415EA6601BD36C3B73E5"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"><a href="../reference/aam-glossary.md"> Woordenlijst Auditiebeheer</a> </td> 
   <td colname="col2"> <p>Definities voor termen die vaak worden gebruikt in Audience Manager en koppelingen naar verdere lezen. </p> </td> 
  </tr> 
  <tr> 
