...
seo-description: Een lijst van nieuwe of herziene documenten die in 2018 en voorgaande jaren zijn gepubliceerd. Bevat kleine updates van de Audience Manager-documentatie die mogelijk niet worden behandeld in de releaseopmerkingen van Experience Cloud.
seo-title: Documentatie-updates 2018
...
<table id="table_9017F44983CC49E888BE3470430D7ACB"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Wij hebben de documentatie bijgewerkt om de nieuwe onderzoek en het filtreren mogelijkheden voor testgroepen te omvatten. Zie <a href="../features/audience-lab/audience-lab.md#search-and-filter"> de sectie van de Groepen van de Test van het Onderzoek en van de Filter</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/system-components/components-data-action.md"> IRIS-optimalisaties</a> </p> </td> 
   <td colname="col2"> <p>Zie <b>Regels voor segmenttoewijzing</b> voor meer informatie over de reeks regels die IRIS volgt wanneer het verzenden van segmenten naar bestemmingen. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Voor klanten die Audience Manager en Adobe Analytics gebruiken: De gebruikersinterface van de Audience Manager staat u niet toe om gegevensbronnen te schrappen die automatisch van uw het rapportreeksen van Analytics worden gecreeerd. Gebruik <a href="https://docs.adobe.com/content/help/en/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external"> de Dienst van de Kern </a> om deze gegevensbronnen unmap. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vanaf versie 8.0 is <span class="wintitle"> DIL</span> sterk afhankelijk van <a href="https://docs.adobe.com/content/help/nl-NL/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, versie 3.3 of hoger. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p><a href="../dil/dil-overview.md"> Inzicht in de Data Integration Library (DIL)</a> </p> </td> 
   <td colname="col2"> <p>Gewijzigd <a href="../dil/dil-overview.md"> DIL Code ophalen en implementeren</a> om rekening te houden met het feit dat <span class="keyword"> Adobe Experience Platform Launch</span> het voorkeursgereedschap voor code-implementatie is in de <span class="keyword"> Experience Cloud</span>. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9166897029124C6782E0DE3D816CEA49"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Uw gebruikers zullen beginnen in aanmerking te komen voor een op regel-gebaseerde eigenschap ongeveer 4 uur nadat u <a href="../features/traits/create-onboarded-rule-based-traits.md#create-rules-based-or-onboarded-traits"> de eigenschap </a> in UI creeert. Lees het document voor meer informatie over de kwalificatie van de eigenschap. </p> </td> 
  </tr> 
  <tr> 
