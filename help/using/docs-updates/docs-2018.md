...
<table id="table_BAB960ED4DA1432087A162210681B225"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Voor klanten die Audience Manager en Adobe Analytics gebruiken: De gebruikersinterface van de Audience Manager staat u niet toe om gegevensbronnen te schrappen die automatisch van uw het rapportreeksen van Analytics worden gecreeerd. Gebruik <a href="https://experienceleague.adobe.com/docs/core-services/interface/about-core-services/core-services-landing.html" format="https" scope="external"> de Dienst van de Kern </a> om deze gegevensbronnen unmap. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_01EF3D23C50F4635BFBD55F9D6CE1752"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Vanaf versie 8.0 is <span class="wintitle"> DIL</span> sterk afhankelijk van <a href="https://experienceleague.adobe.com/docs/id-service/using/home.html" format="https" scope="external"><span class="keyword"> Adobe Experience Platform Identity Service</span></a>, versie 3.3 of hoger. </p> </td> 
  </tr> 
  <tr> 
