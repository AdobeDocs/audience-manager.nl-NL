---
description: Een lijst met nieuwe en herziene documentatie van Audience Manager die in 2016 is gepubliceerd. Bevat kleine updates of wijzigingen in de handleiding Audience Manager die mogelijk niet zijn opgenomen in de Opmerkingen bij de release Experience Cloud.
seo-description: Een lijst met nieuwe en herziene documentatie van Audience Manager die in 2016 is gepubliceerd. Bevat kleine updates of wijzigingen in de handleiding Audience Manager die mogelijk niet zijn opgenomen in de Opmerkingen bij de release Experience Cloud.
seo-title: 2016 Documentatieupdates
solution: Audience Manager
title: 2016 Documentatieupdates
...
Een lijst met nieuwe en herziene documentatie van Audience Manager die in 2016 is gepubliceerd. Bevat kleine updates of wijzigingen in de handleiding Audience Manager die mogelijk niet zijn opgenomen in de Opmerkingen bij de release Experience Cloud.
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/report-sampling.md"> Gegevenssampling en foutenpercentages in de geselecteerde Rapporten van de Manager van de Publiek... </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bevat een nieuwe vermelding over IP- en FTP-adressen van <span class="keyword"> Audience Manager</span> voor witte lijsten. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Documentatie waarin een nieuwe DIL-methode wordt beschreven waarmee u gegevens van Universal Analytics van Google kunt verzenden naar <span class="keyword"> Audience Manager</span> . </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <span class="keyword"> Audience Manager</span> handelt de verificatiestatus van de bezoeker-id <code> UNKNOWN</code> en <code> LOGGED_OUT</code> op dezelfde manier af. Het document bevat meer informatie over hoe we <code> setCustomerID</code> gebeurtenisaanroepen afhandelen. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Raadpleeg dit document voor een volledige lijst met id's van <span class="keyword"> Audience Manager</span> . </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-audience-lab.md"> Veelgestelde vragen over publiek Lab </a> </p> </td> 
   <td colname="col2"> <p>Veelgestelde vragen over de functie Lab <span class="wintitle"> van het</span> publiek. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <a href="../integration/receiving-audience-data/real-time-outbound-transfers/oauth-in-outbound-transfers.md"> OAuth 2.0 Integratie voor Uitgaande Overdrachten in real time </a> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/merge-rule-definitions.md"> Opties voor regel voor samenvoegen van profiel gedefinieerd </a> </p> </td> 
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="https://docs.adobe.com/content/help/en/core-services/interface/ec-cookies/cookies-am.html" format="https" scope="external"> Cookies die worden gebruikt in de Experience Cloud</a> </td> 
   <td colname="col2"> De time-to-live (TTL)-waarde van het demdex-cookie en het partner cookie is gewijzigd in 180 dagen om te voldoen aan de Franse CNIL-regels. </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../dil/dil-overview.md"> De Data Integration Library (DIL) </a> </td> 
   <td colname="col2">Een algemeen overzicht van de <span class="wintitle"> Data Information Library</span> (DIL). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md"> Inhoud binnenkomend gegevensbestand: Syntaxis, ongeldige tekens, variabelen en voorbeelden </a> </td> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> Apparaatgericht met toetsen op platformniveau </a> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../integration/receiving-audience-data/real-time-outbound-transfers/real-time-outbound-transfers.md"> Uitgaande gegevensoverdrachten in real time </a> </p> </td> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/traits/trait-geotarget-keys.md"> Geotarcering met toetsen op platformniveau </a> </p> </td> 
   <td colname="col2"> <p>De lijst met sleutels is bijgewerkt met de meest recente waarden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../features/traits/trait-device-targeting.md"> Apparaatgericht met toetsen op platformniveau </a> </td> 
   <td colname="col2"> <p>Een nieuw document waarin de algemene sleutelwaardeparen op platformniveau worden beschreven die u kunt gebruiken om gebruikers met apparaat-verwante variabelen over alle eigenschappen in uw rekening van de Manager van de Publiek te richten. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Verwijderd uit de documentatie van Audience Manager <span class="keyword"></span> in september 2017. Verplaatst naar <span class="keyword"> documentatie van Analytics</span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> Ervaar de versies van de Cloud Visitor ID </p> </td> 
   <td colname="col2"> <p>Herziene tekst voor id's 1 en 2. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/profile-merge-rules/merge-rules-dashboard.md"> Het dashboard Regels voor samenvoegen van profielen </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="https://docs.adobe.com/content/help/en/audience-manager/user-guide/implementation-integration-guides/integration-experience-platform/aam-aep-audience-sharing.html" format="https" scope="external"> Segmenten van Audience Manager in Analytics</a> </p> </td> 
   <td colname="col2"> <p>De segmenten van de Manager van de Publiek van het aandeel met Analytics in real time. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Beschrijft hoe de de gegevensleveranciers van de Marketplace <span class="wintitle"></span> van het Publiek het voer van een abonnee deactiveren. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md"> Wat gebeurt er nadat een provider mijn gegevensfeed deactiveert </a> </p> </td> 
   <td colname="col2"> <p>Beschrijft wat een de gegevenskoper van de Marketplaats <span class="wintitle"></span> van het Publiek kan verwachten als een leverancier toegang tot een gegevensvoer herroept. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-api-reference/dcs-error-codes.md"> DCS-foutcodes, berichten en voorbeelden </a> </p> </td> 
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../api/dcs-intro/dcs-s2s/dcs-s2s-calls.md"> Server-aan-Server DCS API Vraag maken</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nieuwe documentatie die van de punten in een het facturerings rapport van de Marketplace van het <span class="wintitle"> Publiek een lijst maakt en bepaalt</span> . </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#marketplace-buyer-details"> De pagina met abonnementsdetails in Audience Marketplace begrijpen </a> </p> </td> 
