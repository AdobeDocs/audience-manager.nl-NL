...
| Onderwerp | Beschrijving |
|--- |----|
| [HTTP Strict-Transport-Security](../overview/data-security-and-privacy/data-security.md#hsts) | We hebben ondersteuning toegevoegd voor [!DNL HTTP Strict-Transport-Security], een webbeveiligingsbeleid dat bescherming biedt tegen het kapen van cookies en aanvallen van downgraden van protocollen. |
...
| Onderwerp | Beschrijving |
|--- |----|
| [Startpagina Bestemmingen](/help/using/features/destinations/destinations-home.md) | De landingspagina [Doelen](https://bank.demdex.com/portal/destinations/all) heeft een nieuw uiterlijk. Lees deze pagina voor informatie over de nieuwe lay-out. |
