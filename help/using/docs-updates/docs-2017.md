---
description: Een lijst van nieuwe of herziene documenten die in 2017 en voorgaande jaren zijn gepubliceerd. Bevat kleine updates van de documentatie van de Audience Manager die mogelijk niet in de releaseopmerkingen van Experience Cloud worden behandeld.
seo-description: Een lijst van nieuwe of herziene documenten die in 2017 en voorgaande jaren zijn gepubliceerd. Bevat kleine updates van de documentatie van de Audience Manager die mogelijk niet in de releaseopmerkingen van Experience Cloud worden behandeld.
...
Een lijst van nieuwe of herziene documenten die in 2017 en voorgaande jaren zijn gepubliceerd. Bevat kleine updates van de documentatie van de Audience Manager die mogelijk niet in de releaseopmerkingen van Experience Cloud worden behandeld.
...
<table id="table_18C3AA0411CC4CBC98531BE735934E30"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nieuwe inhoud voor het verzenden van Audience Managers naar Analytics. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_8BA284C2CD324D5F988D9209D9078BE1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Kom te weten waarom <span class="wintitle"> Acteerbare Logdossiers</span> de geadviseerde manier is om DCM logboekdossiers in <span class="keyword"> Audience Manager</span> in te voeren en te leren hoe u met de eigenschap kunt beginnen. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Toegevoegde stap 7, over wat u moet doen om <span class="wintitle"> Handbare Logbestanden</span> toe te laten na het instellen van het DCM-gegevensbestand voor importeren in <span class="keyword"> Audience Manager</span>. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../features/traits/trait-details-page.md"> Detailpagina van taak</a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>De nieuwe inhoud beschrijft hoe te om de segmenten van de Audience Manager naar Target te verzenden. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_FB58595763214BB5BBC778733FF0778C"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"><a href="../features/traits/trait-geotarget-keys.md"> Uitlijnen met toetsen op het niveau van het Platform</a> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>U kunt verschillende typen en bronnen van modellen in <span class="keyword"> Audience Manager</span>gebruiken. <span class="wintitle"> Het Laboratorium</span> van het publiek biedt een gemakkelijke manier om de omzettingspercentages van uw klanten, over uw actieve modellen te vergelijken. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_9D6D2244D23648F9AC4D1F5E40BDCF14"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p><a href="../integration/sending-audience-data/batch-data-transfer-explained/batch-data-transfer-overview.md"> Batchgegevens naar Audience Manager verzenden - Overzicht</a> </p> </td> 
...
<table id="table_237E64BBFEF84A8E97EE61E6CD5F371F"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p><a href="../api/dcs-intro/dcs-api-reference/dcs-keys.md"> Ondersteunde kenmerken voor DCS API-aanroepen</a> </p> </td> 
   <td colname="col2"> <p>Bijgewerkt de Belangrijkste Veranderlijke Voorvoegsels met <code> _p</code>, identificerend privé parameters in Audience Manager. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_8D727AAADA224AF687E41C26CBFB1CC2"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bijgewerkt met de verwachte indeling voor mobiele apparaat-id's (DAID) die door de <span class="keyword"> Audience Manager</span>wordt verwerkt. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nieuw item toegevoegd dat de <span class="keyword"> Experience Cloud</span> <span class="wintitle"> -organisatie-id</span>beschrijft, inclusief informatie over hoe u het kunt vinden. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> 
