...
Koppelingen naar [!DNL Audience Manager] releaseopmerkingen en documentwijzigingen. Zie de sectie Opmerkingen bij [!DNL Experience Cloud] vorige release voor een archief met oudere wijzigingen op [](https://docs.adobe.com/content/help/nl-NL/release-notes/experience-cloud/current.html) niveau.
