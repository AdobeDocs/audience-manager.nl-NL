...
Koppelingen naar de releaseopmerkingen en documentatiewijzigingen van [!DNL Audience Manager]. Zie de sectie [Opmerkingen bij vorige release](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) voor een archief met oudere wijzigingen op [!DNL Experience Cloud]-niveau.
