...
| [Audience Manager-plug-in voor IAB TCF ](../overview/data-security-and-privacy/aam-iab-plugin.md) | Omdat Adobe zich blijft richten op &#39;Privacy door Ontwerp&#39;, werken we de insteekmodule Audience Manager voor IAB TCF bij naar IAB Transparency &amp; Consent Framework (TCF) versie 2.0, die 10 juni 2020 begint. Klanten die de plug-in Audience Manager voor IAB TCF hebben geïmplementeerd, moeten vóór 15 augustus 2020 een upgrade naar versie 2.0 uitvoeren om de functie te kunnen blijven gebruiken. Na 15 augustus 2020 wordt versie 1.1 afgekeurd en wordt deze niet meer ondersteund. |
