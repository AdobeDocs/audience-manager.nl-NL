...
| [Nieuwe SFTP-servers](../faq/faq-data-collection.md) | U kunt nu de nieuwe [!DNL SFTP] servers (`ftp-in-gtw` en `ftp-out-gtw`) gebruiken die [!DNL AWS SFTP Gateway] over gebruiken [!DNL S3]. |
