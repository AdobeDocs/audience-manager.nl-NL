...
|----|----|
| [Predictieve doelgroepen](/help/using/features/algorithmic-models/predictive-audiences.md) | <ul><li>**Predictive Audiences Model Cloning**: U kunt nu bestaande modellen klonen en de configuratie ervan wijzigen op basis van uw behoeften. Lees [Klonen en Voorspelende modellen](/help/using/features/algorithmic-models/predictive-audiences.md#clone-predictive-audiences) van het publiek het Uitgeven voor meer informatie.</li><li>**Voorspelende batchclassificatie** voor doelgroepen: Naast het classificeren van bezoekers in verschillende personen in real-time, ondersteunt het Predictive publiek nu batchclassificatie, zodat u geregistreerde gebruikers kunt classificeren en naar batchbestemmingen kunt activeren.</li></ul> |
| [Rapporten overlappen](/help/using/reporting/dynamic-reports/dynamic-reports.md) | We hebben de methodologie bijgewerkt die we gebruiken voor het berekenen van Overlap Reports ([Trait-to-Trait](/help/using/reporting/dynamic-reports/trait-trait-overlap-report.md), [Segment-to-Trait](/help/using/reporting/dynamic-reports/segment-trait-overlap-report.md), [Segment-aan-Segment](/help/using/reporting/dynamic-reports/segment-segment-overlap-report.md)). De berekening van overlappende rapporten is nu gebaseerd op de rapporteringsuniques en MinHash-handtekeningen (in plaats van [1/54 gegevensbemonstering](/help/using/reporting/report-sampling.md#data-sampling-ratio)). |
...
| Onderwerp | Beschrijving |
|---- |----|
| [Google Customer Match voor op mensen gebaseerde doelen](../features/destinations/people-based-destinations-prerequisites.md#gcm) | U kunt nu gebruiken [!UICONTROL People-Based Destinations] om gebruikers als doel in te stellen via [!DNL Google Customer Match]. Alvorens u kunt gebruiken [!UICONTROL People-Based Destinations] om uw eerste-partijpubliekssegmenten naar een [!DNL Google Customer Match] bestemming te verzenden, is het verplicht die u aan hun lijst van gewenste personen [!DNL Google] toevoegt. Raadpleeg de [documentatie bij Op mensen gebaseerde doelen](../features/destinations/people-based-destinations-prerequisites.md#gcm) voor meer informatie. |
| [Nieuwe SFTP-servers](../faq/faq-data-collection.md) | U kunt nu de nieuwe [!DNL SFTP] servers ([!DNL ftp-in-gtw] en [!DNL ftp-out-gtw]) gebruiken die [!DNL AWS SFTP Gateway] over gebruiken [!DNL S3]. |
...
| Onderwerp | Beschrijving |
|---- |----|
| [Doelgroepen delen tussen Audience Manager en Adobe Experience Platform](/help/using/integration/integration-aep/aam-aep-audience-sharing.md#aep-aam-segment-population-differences) | In het nieuwe deel, **Begrijp de verschillen in segmentpopulatie tussen Audience Manager en Experience Platform**, worden de mogelijke redenen beschreven waarom de bevolkingsaantallen tussen Experience Platform en Audience Manager kunnen variëren. |
| [Aan de slag met Audience Manager REST API&#39;s](/help/using/api/rest-api-main/aam-api-getting-started.md#jwt) | We hebben een nieuwe sectie toegevoegd, **JWT-verificatie (Service Account) met gebruik van[!DNL Adobe I/O]**. Raadpleeg deze sectie om de Audience Manager-API&#39;s te verifiëren met [!DNL Adobe I/O]. |
