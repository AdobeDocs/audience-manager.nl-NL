---
description: Een lijst met nieuwe en herziene documentatie van Audience Manager die in 2015 is gepubliceerd. Bevat kleine updates of wijzigingen in de handleiding Audience Manager die mogelijk niet zijn opgenomen in de Opmerkingen bij de release Experience Cloud.
seo-description: Een lijst met nieuwe en herziene documentatie van Audience Manager die in 2015 is gepubliceerd. Bevat kleine updates of wijzigingen in de handleiding Audience Manager die mogelijk niet zijn opgenomen in de Opmerkingen bij de release Experience Cloud.
...
Een lijst met nieuwe en herziene documentatie van Audience Manager die in 2015 is gepubliceerd. Bevat kleine updates of wijzigingen in de handleiding Audience Manager die mogelijk niet zijn opgenomen in de Opmerkingen bij de release Experience Cloud.
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Tekstrevisies en -updates. Ook zijn er nieuwe sleutelwaardeparen opgenomen die nodig zijn om leesbare gegevensnamen te gebruiken en weer te geven in de rapporten <span class="wintitle"> Advertising Analytics</span> . </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="keyword"> Klanten met analysemogelijkheden</span> moeten een integratiecode instellen wanneer ze het Master Marketing Profile gebruiken en gedeclareerde id's doorgeven via de Bezoeker-id-service aan <span class="keyword"> Audience Manager</span>. </p> <p>Dit document is afgekeurd en is vervangen door <a href="../features/profile-merge-rules/merge-rules-start.md"> Een gegevensbron</a>voor meerdere apparaten maken. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Bijgewerkte tekst en nieuwe beelden die verklaren hoe de diverse systemen van de Manager <span class="keyword"> van de</span> Publiek werken en hoe de gegevens door ons systeem stromen. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_EA3AF6A1987B4EFDBC84F265D5F47DC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../reporting/audience-optimization-reports/aor-advertisers/import-dcm.md"> DCM-gegevensbestanden importeren in Auditiebeheer</a> </td> 
   <td colname="col2">Breng uw<span class="keyword"> Gegevens van de Manager</span> van de Campagne tweemaal in de Manager <span class="keyword"> van de</span>Publiek. </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_D4F6BB8E192E4C1BAF1B505541A1E56E"> 
      ...
      <li id="li_85A63519222A4423B8D7A3FF90929741">Een notitie toegevoegd aan de <code> declaredId</code> variabele. Wanneer u de Bezoeker-id-service gebruikt, stelt u de id in met <code> setCustomerIDs</code> in plaats van met DIL. Zie <a href="https://marketing.adobe.com/resources/help/en_US/mcvid/?f=mcvid_customer_ids.html" format="https" scope="external"> Klant-id's en Geverifieerde statussen</a>. </li> 
     </ul> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E3544AE9796D43408FBEC64CA5B493D8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> Publiek Marketplace laat gegevensleveranciers en kopers gegevens op een zelfbedieningsmanier uitvoeren met minimale moeite. Dit doet hij door speciale functies te bieden die afhankelijk zijn van je rol als gegevenskoper of gegevensverkoper. </td> 
  </tr> 
  <tr> 
...
<table id="table_A9AF62AC1D434B87BF4CB29BB1FE9EE0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nieuw onderwerp. </p> <p>Gewijzigd in de veelgestelde vragen <a href="../faq/faq-privacy.md"></a> over privacy en gegevensbewaring (12/2016). </p> </td> 
  </tr> 
 </tbody> 
</table>
