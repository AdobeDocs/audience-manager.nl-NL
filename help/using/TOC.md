...
+ Rapportage {#reporting}
   ...
   + Audience Optimization-rapporten {#audience-optimization-reports}
      ...
      + Doelgroepoptimalisatie voor uitgevers {#audience-optimization-publishers}
         ...
         + [DFP-databestanden importeren in Audience Manager](reporting/audience-optimization-reports/aor-publishers/import-dfp.md)
...
+ Implementatie- en integratiehandleidingen {#implementation-integration-guides}
   ...
   + Integreren met bestemmingen van derden {#integrating-third-party}
      ...
      + [DFP als Audience Manager-bestemming](integration/aam-dfp.md)
   ...
   + Integratie met andere Experience Cloud-oplossingen {#integration-other-solutions}
      ...
      + [Een Adobe Analytics-segment publiceren naar de Experience Cloud (opent Adobe Analytics-documentatie)](https://docs.adobe.com/content/help/nl-NL/core-services/interface/audiences/t-publish-audience-segment.html)
